...
const MESSAGES = Object.freeze({
  ko: {
    ...
    controls: 'A/D 또는 ←/→ 이동 · Space 점프 · E/Enter 상호작용', ready: '준비', 'ready.done': '준비 완료',
    ...
    'hint.anchor': '단자에서 E를 길게 눌러 고정하세요', 'hint.switch': '파트너가 고정했습니다. 스위치에서 E를 누르세요', 'hint.checkpoint': '둘이 함께 별빛 체크포인트로 이동하세요',
    respawn: '별빛 체크포인트로 함께 복귀 중', 'event.powered': '전력 연결! 파트너가 움직일 차례입니다', 'event.latched': '장치 잠금 완료', 'event.checkpoint': '공동 체크포인트 갱신', 'event.fall': '추락! 함께 복귀합니다', 'event.finish': '두 신호가 결합했습니다. 별빛 우편 발사!', 'event.expired': '동시 신호 시간이 지나 다시 준비합니다.',
  ...
  en: {
    ...
    controls: 'A/D or ←/→ move · Space jump · E/Enter interact', ready: 'Ready', 'ready.done': 'Ready!',
    ...
    'hint.anchor': 'Hold E at the terminal to anchor', 'hint.switch': 'Partner anchored. Press E at the switch', 'hint.checkpoint': 'Move together into the starlight checkpoint',
    respawn: 'Returning together to the starlight checkpoint', 'event.powered': 'Power linked! Your partner can move', 'event.latched': 'Device latched', 'event.checkpoint': 'Team checkpoint updated', 'event.fall': 'Fall! Returning together', 'event.finish': 'Signals linked. Starlight mail launched!', 'event.expired': 'The signal window expired. Try together again.',
