...
export class GameNetwork extends EventTarget {
  ...
  /** @returns {void} 명시적으로 방을 떠나고 자동 재접속을 중단한다. */ leave(){this.closed=true;this.send({type:'LEAVE_MATCH'});setTimeout(()=>this.socket?.close(),80);}
}
