...
LAN 환경에서 2~6명이 IP 접속으로 대결하는 한게임 테트리스 아이템전 스타일의 웹 게임. 혼자일 땐 AI 봇과 1:1 대전도 가능하다.
...
| LAN 2~6인 멀티룸 | `Map<roomId, Room>` 기반 독립 룸. 현재 입장 인원 전원 READY 시 시작, 입장 순서 번호 고정, 탈락 관전과 최후 생존 승리. `?room=<id>` 초대 링크, AI 전용 룸 격리, 인원 0명 즉시 소멸 | 완료 (2026-08-13) |
